...
class WhisperClient: @unchecked Sendable {
    ...
    func loadModel(_ modelSize: WhisperConfiguration.ModelSize) async throws {
        ...
        let modelFileName = modelSize.modelFileName
        print("🎤 Looking for model: \(modelFileName)")
        ...
        if let bundlePath = Bundle.main.resourcePath {
            ...
            do {
                ...
                let targetFile = "\(modelFileName).bin"
        ...
        // First try the exact model name that was requested
        let possibleNames = [modelFileName, "ggml-small", "model", "base", "small"]
        ...
        if Bundle.main.url(forResource: modelFileName, withExtension: "mlmodelc") != nil {
            print("🎤 Using Core ML model from app bundle: \(modelFileName)")
    ...
    func isModelAvailable(_ modelSize: WhisperConfiguration.ModelSize) -> Bool {
        ...
        if Bundle.main.url(forResource: modelFileName, withExtension: "bin") != nil {
            print("🎤 Found .bin model in app bundle: \(modelFileName).bin")
            return true
        }
        
        // Then check for Core ML model in app bundle
        if Bundle.main.url(forResource: modelFileName, withExtension: "mlmodelc") != nil {
            print("🎤 Found Core ML model in app bundle: \(modelFileName).mlmodelc")
            return true
        }
